...
function HeroGeometric({
    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-background px-2">
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                <ElegantShape
                    ...
                    className="left-[5%] md:left-[10%] bottom-[5%] md:bottom-[10%] w-[200px] md:w-[300px] h-[60px] md:h-20 opacity-50"
                />
                ...
                <ElegantShape
                    ...
                    className="right-[15%] md:right-[20%] top-[10%] md:top-[15%] w-[150px] md:w-[200px] h-10 md:h-[60px] opacity-50"
                />
                ...
                <ElegantShape
                    ...
                    className="left-[20%] md:left-[25%] top-[5%] md:top-[10%] w-[100px] md:w-[150px] h-[30px] md:h-10 opacity-50"
                />
            </div>
            ...
            <div className="relative z-10 container mx-auto px-4">
                <div className="max-w-4xl mx-auto text-center">
                    <motion.div
                        ...
                        initial="hidden"
                        animate="visible"
                        className="inline-flex items-center gap-2 px-3 py-1 backdrop-blur-md rounded-full bg-black/3 dark:bg-white/3 border border-black/8 dark:border-white/8 mb-8 md:mb-12"
                    >
                        <Circle className="h-2 w-2 fill-rose-500/80 animate-pulse" />
                        <span className="text-xs md:text-sm text-foreground/60 font-serif">
                            {badge}
                        </span>
                    </motion.div>
