                ...
                <div className="relative grid grid-cols-1 md:grid-cols-3 gap-12">
                    ...
                    {steps.map((step, index) => (
                        <div key={index} className="flex flex-col items-center text-center group">
                            <div className={`w-20 h-20 rounded-2xl ${step.bg} ${step.border} border-2 flex items-center justify-center mb-6 shadow-lg backdrop-blur-sm group-hover:scale-110 transition-transform duration-300`}>
                                {step.icon}
                            </div>
